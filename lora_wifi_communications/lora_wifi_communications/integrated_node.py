...
app = Flask(__name__, template_folder='/home/pi1/ros2_ws/src/lora_wifi_communications/lora_wifi_communications/templates', static_folder='static')
...
class IntegratedNode(Node):
    def __init__(self):
        ...
        self.csv_file_path = os.path.join(home_directory, '/home/pi1/Documents/wifi_data/pi_data.csv')
...
def download_file(filename):
    folder_path = app.config.get('folder_path', '/home/pi1/Documents/wifi_data') #default folder ppath
